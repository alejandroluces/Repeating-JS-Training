...
const firshElementStr = (fruitNum) =>{
    ...
    return fruitNum.map((item,index)=>{return{
        elemento: item.find((item)=>typeof item!=="string"), indiceArrExterno: index , inidiceArrInterno: item.findIndex((item)=>typeof item!=="string")
    }}).find((item)=>item.elemento)
...
//    return fruitNum.map((item,index)=>{return{
//     elemento: item.find((item,idx)=> typeof item !== "string"), indiceArrayExterno:index , indiceArrayInterno: item.findIndex((item,idx)=> typeof item !== "string")
//    }}).find((item)=>item.elemento)
