// 34.) Ejercicio: Verificar si una cadena es igual a 'hola' o 'adios'
// Planteamiento: Escribe una función que tome como entrada una cadena y 
// determine si es igual a 'hola' o 'adios'.
...
const validateWords=(words)=>{
    ...
    return words.toLowerCase()==="hola" || words.toLowerCase()==="adios"

}
console.log(validateWords("Adios"));
